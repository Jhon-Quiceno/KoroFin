...
public class ReceiptExtractionService {
     ...
     * @throws com.korofin.backend.ai.exception.AiProviderNotConfiguredException si ningún
     *         proveedor con capacidad de visión está configurado
     * @throws com.korofin.backend.ai.exception.AiProviderException si todos los proveedores con

 ...
 * {@code com.korofin.backend.common.config.RestClientConfig}) se reutiliza tal cual — en particular, esta
...
public class AiChatClient {
     ...
     * {@link com.korofin.backend.ai.service.provider.AiChatOrchestrator} al siguiente proveedor

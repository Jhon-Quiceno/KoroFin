...
/**
 * Payload para crear o actualizar un {@link com.korofin.backend.expense.entity.Expense}.
 *
 * <p>{@link #date} usa {@link PastOrPresent} por la misma razón que
 * {@link com.korofin.backend.income.dto.IncomeRequest#date()}: esta fase modela el gasto como

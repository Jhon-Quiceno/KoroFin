...
/**
 * Payload para editar una {@link com.korofin.backend.card.entity.CreditCard} existente.
 *
 ...
 * un {@link com.korofin.backend.card.entity.CardMovement} registrado — mismo criterio de
 * trazabilidad por el que {@link com.korofin.backend.debt.dto.DebtUpdateRequest} excluye
 * {@code totalAmount}/{@code remainingAmount}.
 *
 * <p>{@code monthlyRate} sí es editable, pero el cambio nunca es retroactivo: cada
 * {@link com.korofin.backend.card.entity.InstallmentPlan} ya creado conserva su

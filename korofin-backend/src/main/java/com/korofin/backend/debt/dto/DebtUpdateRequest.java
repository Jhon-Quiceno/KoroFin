...
/**
 * Payload para editar una {@link com.korofin.backend.debt.entity.Debt} existente.
 *
 * <p>Excluye deliberadamente {@code totalAmount} y {@code remainingAmount}: el saldo restante
 * solo puede cambiar a través de un {@link com.korofin.backend.debt.entity.DebtPayment} (lo
 * reduce) o un {@link com.korofin.backend.debt.entity.DebtCharge} (lo incrementa), nunca por una

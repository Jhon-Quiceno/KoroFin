...
import com.korofin.backend.exception.GlobalExceptionHandler;

/**
 * Tipo base para toda falla al llamar a un proveedor de IA configurado por el operador de la app,
 * a través de {@code com.korofin.backend.service.ai.provider.AiChatClient}.
 *
 ...
 * captura {@code com.korofin.backend.service.ai.provider.AiChatOrchestrator}, que prueba el
